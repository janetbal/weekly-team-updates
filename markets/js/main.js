...
const WeeklyUpdates = {
   ...
   */
  async init() {
    console.log('Markets Weekly Updates initializing...');
  ...
  /**
   * Update generate button visibility based on day
   */
  updateGenerateButton() {
    ...
    if (this.canGenerateToday()) {
      ...
      if (generateHint) {
        ...
        generateHint.textContent = 'Generation available Monday-Tuesday';
      }
    }
  },
